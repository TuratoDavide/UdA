...
<html>
        ...
        <nav class="menu">
            <ul class="menu__list">
                <li class="menu__group"> 
                    <a href="lutenti" class="menu__link">Lista Utenti</a>
                </li>
                <li class="menu__group">         
                    <a href="lsegnalazioni" class="menu__link">Lista segnalazioni</a>
                </li>
                <li class="menu__group">          
                    <a href="lac" class="menu__link">Lista azioni correttive</a>
                </li>
                <li class="menu__group">          
    ...
    <br>
    <c:if test="${bu}">
        <c:if test="${!empty lutenti}">
            <center><table>
                    <tr>
                        <td>#</td>
                        <td>Utenti registrati</td>
                        <td>Tipo utente</td>
                        <td>Partecipazione ad un team</td>
                    </tr>
                    <c:forEach items="${lutenti}" var="e" varStatus="pos">
                        <%boolean es = false;%>
                        <c:if test="${e.username != utente.username}">
                            <tr>
                                <td>${pos.index}</td>
                                <th>${e.username}</th>
                                <th>${e.tipo}</th>
                                    <c:forEach items="${lasse}" var="t">
                                        <c:if test="${t.username.getUsername().equals(e.username)}">
                                            <% es = true;%>
                                        </c:if>
                                    </c:forEach> 
                                    <%
                    ...
                    <c:forEach items="${lseg}" var="e" varStatus="pos">
                        ...
                        <tr>
                            ...
                            <th>${e.riferitaA.name()}</th>
                                <%
                                    if (trovato) {
                                %> <th>Team esistente</th> <%
                                } else {
                                %> <th><a href="<c:url value='/addT/${e.idSegnalazione}' />" >Crea team</a></th> <%
                                    }
                                %>
                        </tr>
                        <%j++;%>
